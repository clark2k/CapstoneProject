    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar" style="background-color:#003300;">
        ...
        <ul id="components-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          ...
          <li class="nav-item">
        <a class="nav-link  text-white" data-bs-target="#components-nav"  href="regitrarrecord.php" >
           <i class="mdi mdi-arrow-down menu-icon text-white"></i><span class="menu-title text-white">Registrar Student Record</span>
        </a>
