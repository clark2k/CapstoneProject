    ...
    <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="navbar-brand-wrapper d-flex justify-content-center" style="background-color:#003300;">
        <div class="navbar-brand-inner-wrapper d-flex justify-content-between align-items-center w-100"  style="background-color:#003300;">  
          <a class="navbar-brand brand-logo" hrf="adminhome.php" style="color:white; background-color:#003300;">CITE's Dashboard</a>
        ...
        <ul class="navbar-nav navbar-nav-right">
          ...
          <li class="nav-item nav-profile dropdown" style="color:white;">
            <a class="nav-link dropdown-toggle" href="#" data-bs-toggle="dropdown" id="profileDropdown">
              ...
              <span class="nav-profile-name text-white">Cite Admin</span>
            </a>
...
<ul>
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar" style="background-color:#003300;">
        <ul class="nav">
          <li class="nav-item">
            <a class="nav-link" href="cite.php">
          ...
          <li class="nav-item">
        <a class="nav-link  text-white" data-bs-target="#components-nav"   href="citerecord.php" >
           <i class="mdi mdi-arrow-down menu-icon text-white"></i><span class="menu-title text-white">Student Record</span>
        </a>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header" style="background-color: #1a6600;">
        <h5 class="modal-title text-white" id="teacherRegModalLabel" style="font-weight:bold;">Register As Teacher</h5>
      ...
      <div class="modal-body">
        <form action="../process.php" method="POST">
          ...
          <div class="input-group mb-3">
            ...
            <input type="text" name="teacher_fname" required placeholder="Enter your First Name" class="form-control">
          </div>
          ...
          <div class="input-group mb-3">
            ...
            <input type="text" name="teacher_lname" required placeholder="Enter your Last Name" class="form-control">
          </div>
          ...
          <div class="input-group mb-3">
            ...
            <input type="email" name="teacher_email" required placeholder="Enter your Email" class="form-control">
          </div>
          ...
          <div class="input-group">
            ...
            <input type="password" name="teacher_pass" required placeholder="Enter your Password" class="form-control">
          </div>
